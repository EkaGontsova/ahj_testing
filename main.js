...
;// ./src/pic/visa.svg
const visa_namespaceObject = __webpack_require__.p + "446666af2545c08c5403.svg";
;// ./src/pic/master.svg
const master_namespaceObject = __webpack_require__.p + "4cc519d1c9149b9a464e.svg";
;// ./src/pic/amex.svg
const amex_namespaceObject = __webpack_require__.p + "50aaeda9906d7f7b5e73.svg";
;// ./src/pic/mir.svg
const mir_namespaceObject = __webpack_require__.p + "f5a76114b4f3bf476c38.svg";
;// ./src/pic/union.svg
const union_namespaceObject = __webpack_require__.p + "4d052e8f183619546f2c.svg";
  ...
  return Cards_createClass(Cards, [{
    ...
    value: function activateCards() {
      this.cardImages.forEach(function (image) {
        return image.classList.remove("with-opacity");
      });
    }
  }, {
    key: "deActivateCards",
...
var Form = /*#__PURE__*/function () {
  function Form() {
    ...
    this.labelElement.textContent = "Enter card number";
    this.inputElement = document.createElement("input");
    this.inputElement.classList.add("form__input");
    this.inputElement.id = "cardNumber";
    this.inputElement.type = "text";
    this.inputElement.placeholder = "Enter card number";
...
function cardValidation(input) {
  ...
  var firstTwoDigits = +input.slice(0, 2);
  var firstFourDigits = +input.slice(0, 4);
  ...
  return app_createClass(App, [{
    ...
    value: function onFormSubmit(event) {
      ...
      if (!inputLength) {
        ...
        var result = cardValidation(cardNumber);
        if (result) {
          text = result;
